...
const Header = () => {
    return (
        <div className="header-container row g-3">
            ...
            <div className="col-md-12 header-columns header-second-column">
