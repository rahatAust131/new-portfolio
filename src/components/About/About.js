import { faFacebook, faGithub, faGooglePlusSquare, faInstagram, faLinkedinIn, faYoutube } from '@fortawesome/free-brands-svg-icons';
import { faDownload } from '@fortawesome/free-solid-svg-icons';
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import React from 'react';
import myImage from '../../images/me/img2.jpg';
import './About.css';
            ...
            <div className="row g-3 m-auto about-section">
                ...
                <div className="col-md-9 about-columns about-second-column">
                    <div className="w-100">
                        ...
                        <br />
                        <a href='https://drive.google.com/u/0/uc?id=17xb8QK7NORhnLaqdtu_ENnTma58pHjLV&export=download'><button className="btn btn-brand"><FontAwesomeIcon icon={faDownload} className="" /> Download CV</button></a>
                        <a href="https://mail.google.com/mail/u/0/?tab=rm#inbox?compose=GTvVlcRzCbcgXhxTpwsctgDxNNspJjFDbgZmvgcDGghbBmXbtwjnVgFlWWHcwcqSnPXFdwTJtBBCS"><button className="btn contact-btn"><FontAwesomeIcon icon={faGooglePlusSquare} className="" /> Contact Me</button></a>
                    </div>
                </div>
            </div>
        </div>
